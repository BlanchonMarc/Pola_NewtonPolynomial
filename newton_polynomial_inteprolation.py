...
def interpolate(I):
    ...
    step = 2
    O[0:m:step, 0:n:step] = 0
    O[0:m:step, 1:n:step] = 1
    O[1:m:step, 1:n:step] = 2
    O[1:m:step, 0:n:step] = 3
    ...
    for i in range(3, m-2):
        for j in range(3, n-2):
            R[i, j, O[i, j]] = I[i, j]
            R[i, y, O[i, j+1]] = 0.5*I[i, j] + 0.0625*I[i, j-3] - 0.25*I[i, j-2] + \
    ...
    for i in range(3, m-2):
        for j in range(3, n-2):
            ...
            XX2[i, j] = 0.5*I[i, j] + 0.0625*R[i-3, j, O[i, j+1]] - 0.25*I[i-2, j] + 0.4375*R[i-1, j,
                                                                                              O[i, j+1]] + 0.4375*R[i+1, j, O[i, j+1]] - 0.25*I[i+2, j] + 0.0625*R[i+3, j, O[i, j+1]]
            YY1[i, j] = R[i, j, O[i+1, j]]
            YY2[i, j] = 0.5*I[i, j] + 0.0625*R[i, j-3, O[i+1, j]] - 0.25*I[i, j-2] + 0.4375*R[i, j-1,
                                                                                              O[i+1, j]] + 0.4375*R[i, j+1, O[i+1, j]] - 0.25*I[i, j+2] + 0.0625*R[i, j+3, O[i+1, j]]
